...
kubectl create configmap kiss-config `
    ...
    --from-literal=INTERNE_TAAK_CLIENT_ID=$(INTERNE_TAAK_CLIENT_ID) `
    --from-literal=INTERNE_TAAK_OBJECT_TYPE_URL=$(INTERNE_TAAK_OBJECT_TYPE_URL) `
    --from-literal=INTERNE_TAAK_TYPE_VERSION=$(INTERNE_TAAK_TYPE_VERSION) `
...
kubectl create secret generic kiss-secrets `
    ...
    --from-literal=INTERNE_TAAK_CLIENT_SECRET=$(INTERNE_TAAK_CLIENT_SECRET) `
