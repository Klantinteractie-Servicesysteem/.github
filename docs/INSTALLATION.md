...
3. voor het vullen en up to date houden van de elastic-search indexen kunnen cronjobs ingesteld worden. volg hiervoor de instructies in https://github.com/Klantinteractie-Servicesysteem/KISS-Elastic-Sync/blob/main/deploy/README.md
4. (LET OP! Deze stap doen we pas nadat de medewerkers of kennisartikelen zijn geindexeerd) Tenslotte configureren we de relevance tuning binnen Elastic. 
