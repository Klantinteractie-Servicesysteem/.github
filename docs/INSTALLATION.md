...
| `USE_MEDEWERKEREMAIL` | Deze variabele bepaalt of aan een contactverzoek het emailadres van een medewerker meegegeven kan worden. <details><summary>Meer informatie</summary> Als deze variabele op `true` staat, zal in het contactverzoek-formulier, onder de geselecteerde afdeling of groep, een veld staan om het emailadres van een medewerker in te voeren. Direct een contactverzoek voor een medewerker maken kan in deze situatie niet. Als de variabele niet op true staat, of niet is ingesteld, zal er functionaliteit om een medewerker te selecteren beschikbaar zijn. Ook kan er in die situatie direct een contactverzoek voor een medewerker gemaakt worden.</details> |
