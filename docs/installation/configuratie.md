...
|REGISTERS__N__ZAAKSYSTEEM_USE_EXPERIMENTAL_QUERIES   |Feature switch voor het gebruik van de experimentele features die geintroduceerd zijn in [Open Zaak 1.20.0](https://open-zaak.readthedocs.io/en/stable/development/changelog.html#id9) (optioneel) |
