...
| `ELASTIC_EXCLUDED_FIELDS_KENNISBANK`    | Velden dii door een Kennisbank-gebruiker niet doorzocht en niet ingezien mogen worden. <details><summary>Meer informatie </summary>Als deze variabele gespecificeerd is dan kan een Kennisbank-gebruiker niet in deze velden zoeken. De specifieke velden zullen ook niet getoond worden aan de gebruiker. Men moet de veldnamen specificeren zoals ze geconfigureerd zijn in Elasticsearch. Men kan meerdere velden specificeren, gescheiden door een komma. Bijvoorbeeld: `VAC.toelichting,Kennisbank.vertalingen.deskMemo` </details> |
