...
KISS is inmiddels aangepast om te koppelen met [Open Klant 2.x](https://github.com/maykinmedia/open-klant), dus in combinatie met Klantinteracties maakt KISS géén gebruik meer van het Objecttype Interne Taak. 
